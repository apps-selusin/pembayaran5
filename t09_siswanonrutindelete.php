...
$t09_siswanonrutin_delete = NULL; // Initialize page object first

class ct09_siswanonrutin_delete extends ct09_siswanonrutin {
	...
	// Page object name
	var $PageObjName = 't09_siswanonrutin_delete';
	...
	function Page_Main() {
		...
		if ($sFilter == "")
			$this->Page_Terminate("t09_siswanonrutinlist.php"); // Prevent SQL injection, return to list

		// Set up filter (SQL WHHERE clause) and get return SQL
		// SQL constructor in t09_siswanonrutin class, t09_siswanonrutininfo.php
		...
		if ($this->CurrentAction == "I") { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->Page_Terminate("t09_siswanonrutinlist.php"); // Return to list
			}
		}
	}
...
// Create page object
if (!isset($t09_siswanonrutin_delete)) $t09_siswanonrutin_delete = new ct09_siswanonrutin_delete();

// Page init
$t09_siswanonrutin_delete->Page_Init();

// Page main
$t09_siswanonrutin_delete->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t09_siswanonrutin_delete->Page_Render();
?>
...
var CurrentForm = ft09_siswanonrutindelete = new ew_Form("ft09_siswanonrutindelete", "delete");

// Form_CustomValidate event
ft09_siswanonrutindelete.Form_CustomValidate = 
...
ft09_siswanonrutindelete.ValidateRequired = true;
<?php } else { ?>
ft09_siswanonrutindelete.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft09_siswanonrutindelete.Lists["x_nonrutin_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Jenis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t08_nonrutin"};
...
<?php $t09_siswanonrutin_delete->ShowPageHeader(); ?>
<?php
$t09_siswanonrutin_delete->ShowMessage();
?>
<form name="ft09_siswanonrutindelete" id="ft09_siswanonrutindelete" class="form-inline ewForm ewDeleteForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t09_siswanonrutin_delete->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t09_siswanonrutin_delete->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t09_siswanonrutin">
<input type="hidden" name="a_delete" id="a_delete" value="D">
<?php foreach ($t09_siswanonrutin_delete->RecKeys as $key) { ?>
...
<?php if ($t09_siswanonrutin->siswa_id->Visible) { // siswa_id ?>
		<th><span id="elh_t09_siswanonrutin_siswa_id" class="t09_siswanonrutin_siswa_id"><?php echo $t09_siswanonrutin->siswa_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t09_siswanonrutin->nonrutin_id->Visible) { // nonrutin_id ?>
		<th><span id="elh_t09_siswanonrutin_nonrutin_id" class="t09_siswanonrutin_nonrutin_id"><?php echo $t09_siswanonrutin->nonrutin_id->FldCaption() ?></span></th>
<?php } ?>
<?php if ($t09_siswanonrutin->Nilai->Visible) { // Nilai ?>
		<th><span id="elh_t09_siswanonrutin_Nilai" class="t09_siswanonrutin_Nilai"><?php echo $t09_siswanonrutin->Nilai->FldCaption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
<?php
$t09_siswanonrutin_delete->RecCnt = 0;
$i = 0;
while (!$t09_siswanonrutin_delete->Recordset->EOF) {
	$t09_siswanonrutin_delete->RecCnt++;
	$t09_siswanonrutin_delete->RowCnt++;

	// Set row properties
	$t09_siswanonrutin->ResetAttrs();
	$t09_siswanonrutin->RowType = EW_ROWTYPE_VIEW; // View

	// Get the field contents
	$t09_siswanonrutin_delete->LoadRowValues($t09_siswanonrutin_delete->Recordset);

	// Render row
	$t09_siswanonrutin_delete->RenderRow();
?>
	<tr<?php echo $t09_siswanonrutin->RowAttributes() ?>>
<?php if ($t09_siswanonrutin->siswa_id->Visible) { // siswa_id ?>
		<td<?php echo $t09_siswanonrutin->siswa_id->CellAttributes() ?>>
<span id="el<?php echo $t09_siswanonrutin_delete->RowCnt ?>_t09_siswanonrutin_siswa_id" class="t09_siswanonrutin_siswa_id">
...
<span id="el<?php echo $t09_siswanonrutin_delete->RowCnt ?>_t09_siswanonrutin_nonrutin_id" class="t09_siswanonrutin_nonrutin_id">
...
<span id="el<?php echo $t09_siswanonrutin_delete->RowCnt ?>_t09_siswanonrutin_Nilai" class="t09_siswanonrutin_Nilai">
...
<?php
	$t09_siswanonrutin_delete->Recordset->MoveNext();
}
$t09_siswanonrutin_delete->Recordset->Close();
?>
</tbody>
</table>
</div>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t09_siswanonrutin_delete->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
</div>
</form>
<script type="text/javascript">
ft09_siswanonrutindelete.Init();
</script>
<?php
$t09_siswanonrutin_delete->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t09_siswanonrutin_delete->Page_Terminate();
?>
