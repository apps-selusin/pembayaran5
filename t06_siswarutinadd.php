...
$t06_siswarutin_add = NULL; // Initialize page object first

class ct06_siswarutin_add extends ct06_siswarutin {
	...
	// Page object name
	var $PageObjName = 't06_siswarutin_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t06_siswarutinview.php")
...
// Create page object
if (!isset($t06_siswarutin_add)) $t06_siswarutin_add = new ct06_siswarutin_add();

// Page init
$t06_siswarutin_add->Page_Init();

// Page main
$t06_siswarutin_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_siswarutin_add->Page_Render();
?>
...
var CurrentForm = ft06_siswarutinadd = new ew_Form("ft06_siswarutinadd", "add");

// Validate form
ft06_siswarutinadd.Validate = function() {
...
ft06_siswarutinadd.Form_CustomValidate = 
...
ft06_siswarutinadd.ValidateRequired = true;
<?php } else { ?>
ft06_siswarutinadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft06_siswarutinadd.Lists["x_rutin_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Jenis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t05_rutin"};
...
<?php if (!$t06_siswarutin_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t06_siswarutin_add->ShowPageHeader(); ?>
<?php
$t06_siswarutin_add->ShowMessage();
?>
<form name="ft06_siswarutinadd" id="ft06_siswarutinadd" class="<?php echo $t06_siswarutin_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_siswarutin_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_siswarutin_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t06_siswarutin_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft06_siswarutinadd.Init();
</script>
<?php
$t06_siswarutin_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_siswarutin_add->Page_Terminate();
?>
