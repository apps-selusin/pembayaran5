...
$t09_siswanonrutintemp_grid = NULL; // Initialize page object first

class ct09_siswanonrutintemp_grid extends ct09_siswanonrutintemp {
	...
	// Page object name
	var $PageObjName = 't09_siswanonrutintemp_grid';

	// Grid form hidden field names
	var $FormName = 'ft09_siswanonrutintempgrid';
...
//			if (!isset($GLOBALS["Table"])) $GLOBALS["Table"] = &$GLOBALS["t09_siswanonrutintemp"];
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	function LoadFormValues() {
		...
		$this->nonrutin_id->setOldValue($objForm->GetValue("o_nonrutin_id"));
		if (!$this->siswanonrutin_id->FldIsDetailKey) {
			$this->siswanonrutin_id->setFormValue($objForm->GetValue("x_siswanonrutin_id"));
		}
		$this->siswanonrutin_id->setOldValue($objForm->GetValue("o_siswanonrutin_id"));
		...
		$this->Bayar->setOldValue($objForm->GetValue("o_Bayar"));
	...
	function RenderRow() {
		...
		$this->Sisa->ViewCustomAttributes = "";
			...
			$this->Bayar->EditValue = ew_FormatNumber($this->Bayar->EditValue, -2, -1, -2, 0);
