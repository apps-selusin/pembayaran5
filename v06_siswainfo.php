...
//
// Table class for v06_siswa
//
class cv06_siswa extends cTable {
	var $id;
	var $sekolah_id;
	var $kelas_id;
	var $NIS;
	...
	function __construct() {
		...
		$this->TableVar = 'v06_siswa';
		$this->TableName = 'v06_siswa';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v06_siswa`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new cField('v06_siswa', 'v06_siswa', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->id->Sortable = TRUE; // Allow sort
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// sekolah_id
		$this->sekolah_id = new cField('v06_siswa', 'v06_siswa', 'x_sekolah_id', 'sekolah_id', '`sekolah_id`', '`sekolah_id`', 3, -1, FALSE, '`sekolah_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// kelas_id
		$this->kelas_id = new cField('v06_siswa', 'v06_siswa', 'x_kelas_id', 'kelas_id', '`kelas_id`', '`kelas_id`', 3, -1, FALSE, '`kelas_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NIS
		$this->NIS = new cField('v06_siswa', 'v06_siswa', 'x_NIS', 'NIS', '`NIS`', '`NIS`', 200, -1, FALSE, '`NIS`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->NIS->Sortable = TRUE; // Allow sort
		$this->fields['NIS'] = &$this->NIS;

		// Nama
		$this->Nama = new cField('v06_siswa', 'v06_siswa', 'x_Nama', 'Nama', '`Nama`', '`Nama`', 200, -1, FALSE, '`Nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function GetDetailUrl() {
		...
		// Detail url
		$sDetailUrl = "";
		if ($this->getCurrentDetailTable() == "v07_siswarutinbayar") {
			$sDetailUrl = $GLOBALS["v07_siswarutinbayar"]->GetListUrl() . "?" . EW_TABLE_SHOW_MASTER . "=" . $this->TableVar;
			$sDetailUrl .= "&fk_id=" . urlencode($this->id->CurrentValue);
		}
		if ($sDetailUrl == "") {
			$sDetailUrl = "v06_siswalist.php";
		}
		return $sDetailUrl;
	}
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`v06_siswa`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v06_siswaview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v06_siswaview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "v06_siswaadd.php?" . $this->UrlParm($parm);
		else
			$url = "v06_siswaadd.php";
		return $this->AddMasterUrl($url);
	}
	...
	function GetEditUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v06_siswaedit.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v06_siswaedit.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("v06_siswaadd.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("v06_siswaadd.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("v06_siswadelete.php", $this->UrlParm());
	}
