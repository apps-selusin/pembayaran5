...
$RootMenu->AddMenuItem(10025, "mri_r025fsiswabayar", $Language->MenuPhrase("10025", "MenuText"), "r02_siswabayarsmry.php", -1, "{371AB69E-83C7-4715-818D-BAEB6D2CFBF4}", TRUE, FALSE, FALSE);
$RootMenu->Render();
?>
<!-- End Main Menu -->
