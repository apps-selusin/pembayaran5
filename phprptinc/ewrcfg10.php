...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "admin", "db" => "db_pembayaran5", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '0o2dCBFWef1FIRDy', TRUE); // Random key for encryption
