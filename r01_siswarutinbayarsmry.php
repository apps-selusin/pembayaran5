...
<?php if ($Page->GrpColumnCount + $Page->DtlColumnCount > 0) { ?>
		<td colspan="<?php echo ($Page->GrpColumnCount + $Page->DtlColumnCount) ?>"<?php echo $Page->Nama->CellAttributes() ?>><?php echo str_replace(array("%v", "%c"), array($Page->Jenis->GroupViewValue, $Page->Jenis->FldCaption()), $ReportLanguage->Phrase("RptSumHead")) ?> <span class="ewDirLtr">(<?php echo ewr_FormatNumber($Page->Cnt[1][0],0,-2,-2,-2) ?><?php echo $ReportLanguage->Phrase("RptDtlRec") ?>)</span></td>
<?php } ?>
	</tr>
	<tr<?php echo $Page->RowAttributes(); ?>>
...
<?php } ?>
<?php if ($Page->Nilai_Bayar->Visible) { ?>
		<td data-field="Nilai_Bayar"<?php echo $Page->Nama->CellAttributes() ?>>
