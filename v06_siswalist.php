...
<?php include_once "v07_siswarutinbayargridcls.php" ?>
...
class cv06_siswa_list extends cv06_siswa {
	...
	function __construct() {
		...
		$this->AddUrl = "v06_siswaadd.php?" . EW_TABLE_SHOW_DETAIL . "=";
	...
	function Page_Init() {
		...
		if (@$_POST["ajax"] == "autofill") {
			...
			// Process auto fill for detail table 'v07_siswarutinbayar'
			if (@$_POST["grid"] == "fv07_siswarutinbayargrid") {
				if (!isset($GLOBALS["v07_siswarutinbayar_grid"])) $GLOBALS["v07_siswarutinbayar_grid"] = new cv07_siswarutinbayar_grid;
				$GLOBALS["v07_siswarutinbayar_grid"]->Page_Init();
				$this->Page_Terminate();
				exit();
			}
	...
	function SetupListOptions() {
		...
		// "detail_v07_siswarutinbayar"
		$item = &$this->ListOptions->Add("detail_v07_siswarutinbayar");
	...
	function RenderListOptions() {
		...
		// "detail_v07_siswarutinbayar"
		$oListOpt = &$this->ListOptions->Items["detail_v07_siswarutinbayar"];
		if (TRUE) {
			$body = $Language->Phrase("DetailLink") . $Language->TablePhrase("v07_siswarutinbayar", "TblCaption");
			$body = "<a class=\"btn btn-default btn-sm ewRowLink ewDetail\" data-action=\"list\" href=\"" . ew_HtmlEncode("v07_siswarutinbayarlist.php?" . EW_TABLE_SHOW_MASTER . "=v06_siswa&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($links <> "") {
