...
--
-- Host: localhost
-- Generation Time: Dec 13, 2018 at 11:59 AM
...
(1, 1, 1, 1, NULL, NULL, 0.00, 178000.00),
(2, 1, 2, 2, NULL, NULL, 0.00, 267000.00);
...
(1, 1, 7, 2018, 178000.00, '2018-12-13', 178000.00, '201807', 'Juli 2018', '201812', 'Desember 2018'),
(2, 1, 8, 2018, 178000.00, NULL, 0.00, '201808', 'Agustus 2018', NULL, NULL),
(3, 1, 9, 2018, 178000.00, NULL, 0.00, '201809', 'September 2018', NULL, NULL),
(4, 1, 10, 2018, 178000.00, NULL, 0.00, '201810', 'Oktober 2018', NULL, NULL),
(5, 1, 11, 2018, 178000.00, NULL, 0.00, '201811', 'November 2018', NULL, NULL),
(6, 1, 12, 2018, 178000.00, NULL, 0.00, '201812', 'Desember 2018', NULL, NULL),
(7, 1, 1, 2019, 178000.00, NULL, 0.00, '201901', 'Januari 2019', NULL, NULL),
(8, 1, 2, 2019, 178000.00, NULL, 0.00, '201902', 'Februari 2019', NULL, NULL),
(9, 1, 3, 2019, 178000.00, NULL, 0.00, '201903', 'Maret 2019', NULL, NULL),
(10, 1, 4, 2019, 178000.00, NULL, 0.00, '201904', 'April 2019', NULL, NULL),
(11, 1, 5, 2019, 178000.00, NULL, 0.00, '201905', 'Mei 2019', NULL, NULL),
(12, 1, 6, 2019, 178000.00, NULL, 0.00, '201906', 'Juni 2019', NULL, NULL),
(13, 2, 7, 2018, 267000.00, '2018-12-13', 267000.00, '201807', 'Juli 2018', '201812', 'Desember 2018'),
(14, 2, 8, 2018, 267000.00, NULL, 0.00, '201808', 'Agustus 2018', NULL, NULL),
(15, 2, 9, 2018, 267000.00, NULL, 0.00, '201809', 'September 2018', NULL, NULL),
(16, 2, 10, 2018, 267000.00, NULL, 0.00, '201810', 'Oktober 2018', NULL, NULL),
(17, 2, 11, 2018, 267000.00, NULL, 0.00, '201811', 'November 2018', NULL, NULL),
(18, 2, 12, 2018, 267000.00, NULL, 0.00, '201812', 'Desember 2018', NULL, NULL),
(19, 2, 1, 2019, 267000.00, NULL, 0.00, '201901', 'Januari 2019', NULL, NULL),
(20, 2, 2, 2019, 267000.00, NULL, 0.00, '201902', 'Februari 2019', NULL, NULL),
(21, 2, 3, 2019, 267000.00, NULL, 0.00, '201903', 'Maret 2019', NULL, NULL),
(22, 2, 4, 2019, 267000.00, NULL, 0.00, '201904', 'April 2019', NULL, NULL),
(23, 2, 5, 2019, 267000.00, NULL, 0.00, '201905', 'Mei 2019', NULL, NULL),
(24, 2, 6, 2019, 267000.00, NULL, 0.00, '201906', 'Juni 2019', NULL, NULL);
...
(1, 1, 1, 1, 1490000.00, 0.00, 1490000.00);
...
(1, 1, 1790000.00, '2018-12-13', 100000.00, 1690000.00, '201812', 'Desember 2018', '201812', 'Desember 2018'),
(2, 1, 1690000.00, '2018-12-13', 200000.00, 1490000.00, '201812', 'Desember 2018', '201812', 'Desember 2018');
...
--
-- Stand-in structure for view `v08_siswanonrutinbayar`
-- (See below for the actual view)
--
CREATE TABLE `v08_siswanonrutinbayar` (
`Jenis` varchar(50)
,`a_id` int(11)
,`sekolah_id` int(11)
,`kelas_id` int(11)
...
--
-- Stand-in structure for view `v09_siswabayar`
-- (See below for the actual view)
--
CREATE TABLE `v09_siswabayar` (
`Jenis` varchar(50)
,`a_id` int(11)
,`sekolah_id` int(11)
,`kelas_id` int(11)
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v07_siswarutinbayar`  AS  select `t05_rutin`.`Jenis` AS `Jenis`,`t04_siswa`.`id` AS `a_id`,`t04_siswa`.`sekolah_id` AS `sekolah_id`,`t04_siswa`.`kelas_id` AS `kelas_id`,`t04_siswa`.`NIS` AS `NIS`,`t04_siswa`.`Nama` AS `Nama`,`t06_siswarutin`.`id` AS `b_id`,`t06_siswarutin`.`siswa_id` AS `siswa_id`,`t06_siswarutin`.`rutin_id` AS `rutin_id`,`t06_siswarutin`.`Nilai` AS `b_Nilai`,`t07_siswarutinbayar`.`id` AS `c_id`,`t07_siswarutinbayar`.`siswarutin_id` AS `siswarutin_id`,`t07_siswarutinbayar`.`Bulan` AS `Bulan`,`t07_siswarutinbayar`.`Tahun` AS `Tahun`,`t07_siswarutinbayar`.`Nilai` AS `c_Nilai`,`t07_siswarutinbayar`.`Tanggal_Bayar` AS `Tanggal_Bayar`,`t07_siswarutinbayar`.`Nilai_Bayar` AS `Nilai_Bayar`,0 AS `Sisa`,`t07_siswarutinbayar`.`Periode_Tahun_Bulan` AS `Periode_Tahun_Bulan`,`t07_siswarutinbayar`.`Periode_Text` AS `Periode_Text`,`t07_siswarutinbayar`.`Per_Thn_Bln_Byr` AS `Per_Thn_Bln_Byr`,`t07_siswarutinbayar`.`Per_Thn_Bln_Byr_Text` AS `Per_Thn_Bln_Byr_Text` from (((`t04_siswa` left join `t06_siswarutin` on((`t04_siswa`.`id` = `t06_siswarutin`.`siswa_id`))) left join `t07_siswarutinbayar` on((`t06_siswarutin`.`id` = `t07_siswarutinbayar`.`siswarutin_id`))) left join `t05_rutin` on((`t06_siswarutin`.`rutin_id` = `t05_rutin`.`id`))) ;

-- --------------------------------------------------------

--
-- Structure for view `v08_siswanonrutinbayar`
--
DROP TABLE IF EXISTS `v08_siswanonrutinbayar`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v08_siswanonrutinbayar`  AS  select `t08_nonrutin`.`Jenis` AS `Jenis`,`t04_siswa`.`id` AS `a_id`,`t04_siswa`.`sekolah_id` AS `sekolah_id`,`t04_siswa`.`kelas_id` AS `kelas_id`,`t04_siswa`.`NIS` AS `NIS`,`t04_siswa`.`Nama` AS `Nama`,`t09_siswanonrutin`.`id` AS `b_id`,`t09_siswanonrutin`.`siswa_id` AS `siswa_id`,`t09_siswanonrutin`.`nonrutin_id` AS `nonrutin_id`,`t09_siswanonrutin`.`Nilai` AS `b_Nilai`,`t10_siswanonrutinbayar`.`id` AS `c_id`,`t10_siswanonrutinbayar`.`siswanonrutin_id` AS `siswanonrutin_id`,'' AS `Bulan`,'' AS `Tahun`,`t10_siswanonrutinbayar`.`Nilai` AS `c_Nilai`,`t10_siswanonrutinbayar`.`Tanggal_Bayar` AS `Tanggal_Bayar`,`t10_siswanonrutinbayar`.`Bayar` AS `Bayar`,`t10_siswanonrutinbayar`.`Sisa` AS `Sisa`,`t10_siswanonrutinbayar`.`Periode_Tahun_Bulan` AS `Periode_Tahun_Bulan`,`t10_siswanonrutinbayar`.`Periode_Text` AS `Periode_Text`,`t10_siswanonrutinbayar`.`Per_Thn_Bln_Byr` AS `Per_Thn_Bln_Byr`,`t10_siswanonrutinbayar`.`Per_Thn_Bln_Byr_Text` AS `Per_Thn_Bln_Byr_Text` from (((`t04_siswa` left join `t09_siswanonrutin` on((`t04_siswa`.`id` = `t09_siswanonrutin`.`siswa_id`))) left join `t10_siswanonrutinbayar` on((`t09_siswanonrutin`.`id` = `t10_siswanonrutinbayar`.`siswanonrutin_id`))) left join `t08_nonrutin` on((`t09_siswanonrutin`.`nonrutin_id` = `t08_nonrutin`.`id`))) ;

-- --------------------------------------------------------

--
-- Structure for view `v09_siswabayar`
--
DROP TABLE IF EXISTS `v09_siswabayar`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v09_siswabayar`  AS  select `v07_siswarutinbayar`.`Jenis` AS `Jenis`,`v07_siswarutinbayar`.`a_id` AS `a_id`,`v07_siswarutinbayar`.`sekolah_id` AS `sekolah_id`,`v07_siswarutinbayar`.`kelas_id` AS `kelas_id`,`v07_siswarutinbayar`.`NIS` AS `NIS`,`v07_siswarutinbayar`.`Nama` AS `Nama`,`v07_siswarutinbayar`.`b_id` AS `b_id`,`v07_siswarutinbayar`.`siswa_id` AS `siswa_id`,`v07_siswarutinbayar`.`rutin_id` AS `rutin_id`,`v07_siswarutinbayar`.`b_Nilai` AS `b_Nilai`,`v07_siswarutinbayar`.`c_id` AS `c_id`,`v07_siswarutinbayar`.`siswarutin_id` AS `siswarutin_id`,`v07_siswarutinbayar`.`Bulan` AS `Bulan`,`v07_siswarutinbayar`.`Tahun` AS `Tahun`,`v07_siswarutinbayar`.`c_Nilai` AS `c_Nilai`,`v07_siswarutinbayar`.`Tanggal_Bayar` AS `Tanggal_Bayar`,`v07_siswarutinbayar`.`Nilai_Bayar` AS `Nilai_Bayar`,`v07_siswarutinbayar`.`Sisa` AS `Sisa`,`v07_siswarutinbayar`.`Periode_Tahun_Bulan` AS `Periode_Tahun_Bulan`,`v07_siswarutinbayar`.`Periode_Text` AS `Periode_Text`,`v07_siswarutinbayar`.`Per_Thn_Bln_Byr` AS `Per_Thn_Bln_Byr`,`v07_siswarutinbayar`.`Per_Thn_Bln_Byr_Text` AS `Per_Thn_Bln_Byr_Text` from `v07_siswarutinbayar` union all select `v08_siswanonrutinbayar`.`Jenis` AS `Jenis`,`v08_siswanonrutinbayar`.`a_id` AS `a_id`,`v08_siswanonrutinbayar`.`sekolah_id` AS `sekolah_id`,`v08_siswanonrutinbayar`.`kelas_id` AS `kelas_id`,`v08_siswanonrutinbayar`.`NIS` AS `NIS`,`v08_siswanonrutinbayar`.`Nama` AS `Nama`,`v08_siswanonrutinbayar`.`b_id` AS `b_id`,`v08_siswanonrutinbayar`.`siswa_id` AS `siswa_id`,`v08_siswanonrutinbayar`.`nonrutin_id` AS `nonrutin_id`,`v08_siswanonrutinbayar`.`b_Nilai` AS `b_Nilai`,`v08_siswanonrutinbayar`.`c_id` AS `c_id`,`v08_siswanonrutinbayar`.`siswanonrutin_id` AS `siswanonrutin_id`,`v08_siswanonrutinbayar`.`Bulan` AS `Bulan`,`v08_siswanonrutinbayar`.`Tahun` AS `Tahun`,`v08_siswanonrutinbayar`.`c_Nilai` AS `c_Nilai`,`v08_siswanonrutinbayar`.`Tanggal_Bayar` AS `Tanggal_Bayar`,`v08_siswanonrutinbayar`.`Bayar` AS `Bayar`,`v08_siswanonrutinbayar`.`Sisa` AS `Sisa`,`v08_siswanonrutinbayar`.`Periode_Tahun_Bulan` AS `Periode_Tahun_Bulan`,`v08_siswanonrutinbayar`.`Periode_Text` AS `Periode_Text`,`v08_siswanonrutinbayar`.`Per_Thn_Bln_Byr` AS `Per_Thn_Bln_Byr`,`v08_siswanonrutinbayar`.`Per_Thn_Bln_Byr_Text` AS `Per_Thn_Bln_Byr_Text` from `v08_siswanonrutinbayar` ;
