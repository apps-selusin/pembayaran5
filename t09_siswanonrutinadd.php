...
$t09_siswanonrutin_add = NULL; // Initialize page object first

class ct09_siswanonrutin_add extends ct09_siswanonrutin {
	...
	// Page object name
	var $PageObjName = 't09_siswanonrutin_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "t09_siswanonrutinview.php")
...
// Create page object
if (!isset($t09_siswanonrutin_add)) $t09_siswanonrutin_add = new ct09_siswanonrutin_add();

// Page init
$t09_siswanonrutin_add->Page_Init();

// Page main
$t09_siswanonrutin_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t09_siswanonrutin_add->Page_Render();
?>
...
var CurrentForm = ft09_siswanonrutinadd = new ew_Form("ft09_siswanonrutinadd", "add");

// Validate form
ft09_siswanonrutinadd.Validate = function() {
...
ft09_siswanonrutinadd.Form_CustomValidate = 
...
ft09_siswanonrutinadd.ValidateRequired = true;
<?php } else { ?>
ft09_siswanonrutinadd.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft09_siswanonrutinadd.Lists["x_nonrutin_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Jenis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t08_nonrutin"};
...
<?php if (!$t09_siswanonrutin_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $t09_siswanonrutin_add->ShowPageHeader(); ?>
<?php
$t09_siswanonrutin_add->ShowMessage();
?>
<form name="ft09_siswanonrutinadd" id="ft09_siswanonrutinadd" class="<?php echo $t09_siswanonrutin_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t09_siswanonrutin_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t09_siswanonrutin_add->Token ?>">
<?php } ?>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $t09_siswanonrutin_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
ft09_siswanonrutinadd.Init();
</script>
<?php
$t09_siswanonrutin_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t09_siswanonrutin_add->Page_Terminate();
?>
