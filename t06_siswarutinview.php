...
$t06_siswarutin_view = NULL; // Initialize page object first

class ct06_siswarutin_view extends ct06_siswarutin {
	...
	// Page object name
	var $PageObjName = 't06_siswarutin_view';
	...
	function Page_Main() {
		...
		if ($this->IsPageRequest()) { // Validate request
			if (@$_GET["id"] <> "") {
				...
				$sReturnUrl = "t06_siswarutinlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "I": // Get a record to display
					if (!$this->LoadRow()) { // Load record based on key
						...
						$sReturnUrl = "t06_siswarutinlist.php"; // No matching record, return to list
					}
			}
		} else {
			$sReturnUrl = "t06_siswarutinlist.php"; // Not page request, return to list
		}
		if ($sReturnUrl <> "")
...
// Create page object
if (!isset($t06_siswarutin_view)) $t06_siswarutin_view = new ct06_siswarutin_view();

// Page init
$t06_siswarutin_view->Page_Init();

// Page main
$t06_siswarutin_view->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$t06_siswarutin_view->Page_Render();
?>
...
var CurrentForm = ft06_siswarutinview = new ew_Form("ft06_siswarutinview", "view");

// Form_CustomValidate event
ft06_siswarutinview.Form_CustomValidate = 
...
ft06_siswarutinview.ValidateRequired = true;
<?php } else { ?>
ft06_siswarutinview.ValidateRequired = false; 
<?php } ?>

// Dynamic selection lists
ft06_siswarutinview.Lists["x_rutin_id"] = {"LinkField":"x_id","Ajax":true,"AutoFill":false,"DisplayFields":["x_Jenis","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":"","LinkTable":"t05_rutin"};
...
<div class="ewToolbar">
<?php if (!$t06_siswarutin_view->IsModal) { ?>
<?php $Breadcrumb->Render(); ?>
<?php } ?>
<?php $t06_siswarutin_view->ExportOptions->Render("body") ?>
<?php
	foreach ($t06_siswarutin_view->OtherOptions as &$option)
		$option->Render("body");
?>
<?php if (!$t06_siswarutin_view->IsModal) { ?>
...
<?php $t06_siswarutin_view->ShowPageHeader(); ?>
<?php
$t06_siswarutin_view->ShowMessage();
?>
<form name="ft06_siswarutinview" id="ft06_siswarutinview" class="form-inline ewForm ewViewForm" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($t06_siswarutin_view->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $t06_siswarutin_view->Token ?>">
<?php } ?>
...
<?php if ($t06_siswarutin->siswa_id->Visible) { // siswa_id ?>
	<tr id="r_siswa_id">
		<td><span id="elh_t06_siswarutin_siswa_id"><?php echo $t06_siswarutin->siswa_id->FldCaption() ?></span></td>
...
<?php echo $t06_siswarutin->siswa_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_siswarutin->rutin_id->Visible) { // rutin_id ?>
	<tr id="r_rutin_id">
		<td><span id="elh_t06_siswarutin_rutin_id"><?php echo $t06_siswarutin->rutin_id->FldCaption() ?></span></td>
...
<?php echo $t06_siswarutin->rutin_id->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($t06_siswarutin->Nilai->Visible) { // Nilai ?>
	<tr id="r_Nilai">
		<td><span id="elh_t06_siswarutin_Nilai"><?php echo $t06_siswarutin->Nilai->FldCaption() ?></span></td>
...
<?php echo $t06_siswarutin->Nilai->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<script type="text/javascript">
ft06_siswarutinview.Init();
</script>
<?php
$t06_siswarutin_view->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$t06_siswarutin_view->Page_Terminate();
?>
