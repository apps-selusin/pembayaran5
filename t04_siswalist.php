...
<?php if ($t04_siswa->id->Visible) { // id ?>
	<?php if ($t04_siswa->SortUrl($t04_siswa->id) == "") { ?>
		<th data-name="id"><div id="elh_t04_siswa_id" class="t04_siswa_id"><div class="ewTableHeaderCaption"><?php echo $t04_siswa->id->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_siswa->SortUrl($t04_siswa->id) ?>',1);"><div id="elh_t04_siswa_id" class="t04_siswa_id">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $t04_siswa->id->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($t04_siswa->id->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($t04_siswa->id->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
<?php if ($t04_siswa->sekolah_id->Visible) { // sekolah_id ?>
	...
	<?php } else { ?>
		<th data-name="sekolah_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_siswa->SortUrl($t04_siswa->sekolah_id) ?>',1);"><div id="elh_t04_siswa_sekolah_id" class="t04_siswa_sekolah_id">
...
<?php if ($t04_siswa->kelas_id->Visible) { // kelas_id ?>
	...
	<?php } else { ?>
		<th data-name="kelas_id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_siswa->SortUrl($t04_siswa->kelas_id) ?>',1);"><div id="elh_t04_siswa_kelas_id" class="t04_siswa_kelas_id">
...
<?php if ($t04_siswa->NIS->Visible) { // NIS ?>
	...
	<?php } else { ?>
		<th data-name="NIS"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_siswa->SortUrl($t04_siswa->NIS) ?>',1);"><div id="elh_t04_siswa_NIS" class="t04_siswa_NIS">
...
<?php if ($t04_siswa->Nama->Visible) { // Nama ?>
	...
	<?php } else { ?>
		<th data-name="Nama"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $t04_siswa->SortUrl($t04_siswa->Nama) ?>',1);"><div id="elh_t04_siswa_Nama" class="t04_siswa_Nama">
...
<span id="el<?php echo $t04_siswa_list->RowCnt ?>_t04_siswa_id" class="t04_siswa_id">
...
<span id="el<?php echo $t04_siswa_list->RowCnt ?>_t04_siswa_sekolah_id" class="t04_siswa_sekolah_id">
...
<?php
	...
	if ($t04_siswa->CurrentAction <> "gridadd")
		$t04_siswa_list->Recordset->MoveNext();
}
?>
</tbody>
</table>
